...
2. Install the project dependencies by running `yarn` in the root directory.
3. Create a new branch for your contribution.
4. Make your desired changes or additions.
5. Test them by adding, updating or running existing unit tests. Run `yarn test` to execute the tests
6. Build using `yarn build` and test your changes locally. The documentation for the tool is automatically generated post-build.
