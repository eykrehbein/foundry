...
var CsvTool = class {
  ...
  writeCsvFileSync = (0, import_utils.makeFunction)(
    z.object({
      path: z.string(),
      data: z.array(z.object({})).describe(
  ...
  appendToCsvFileSync = (0, import_utils.makeFunction)(
    ...
    async ({ path, data }) => {
      const dataAsString = (0, import_sync.stringify)(data, {
        header: false
      }).toString();
      import_fs.default.appendFileSync(path, dataAsString, { encoding: "utf-8" });
      return data;
    }
  );
  getCsvFileColumnsSync = (0, import_utils.makeFunction)(
    z.object({
      path: z.string()
    }).describe(
    ...
    ({ path }) => {
      const file = import_fs.default.readFileSync(path, { encoding: "utf-8" });
      const data = (0, import_sync2.parse)(file, { columns: true, autoParse: true });
      if (data.length === 0)
        throw new Error("No data in csv file");
      return Object.keys(data[0]);
    }
  );
  readCsvFileSync = (0, import_utils.makeFunction)(
    z.object({
      path: z.string()
    }).describe(
    ...
    ({ path }) => {
      const file = import_fs.default.readFileSync(path, { encoding: "utf-8" });
      const data = (0, import_sync2.parse)(file, { columns: true });
      return data;
    }
  );
